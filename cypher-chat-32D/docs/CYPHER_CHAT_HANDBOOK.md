# 🛰️ cypher-chat / cypher-chat Handbook
### *Beginner-Friendly Setup & Operation Guide*

Welcome to your secure, off-grid emergency communication system. This handbook will guide you through setting up your **cypher-chat** hardware and using the **cypher-chat** firmware.

---

## 1. Hardware Overview (cypher-chat)

Your cypher-chat board is a specialized gateway. Note the specific requirements:
...
### Configuration
Open `Config.h` to set your identity:
```cpp
...
arduino-cli upload -p PORT --fqbn esp32:esp32:esp32 cypher-chat.ino
```
...
You can control your cypher-chat entirely from your phone without a computer.
...
### Connection Steps
1.  Connect the cypher-chat to your phone using the OTG adapter and USB cable.
...
| `peers` | `p` | Lists all other cypher-chat nodes discovered in the Mesh. |
