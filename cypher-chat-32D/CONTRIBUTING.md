# Contributing to cypher-chat

Thank you for your interest in contributing to cypher-chat! This document provides guidelines for contributing to the project.
...
- `docs/CYPHER_CHAT_HANDBOOK.md` - User guide
- `CLAUDE.md` - Developer architecture reference

## 🐛 Bug Reports

**Before submitting:**
1. Check existing [GitHub Issues](https://github.com/yourusername/cypher-chat/issues)
...
- **Configuration:** Any changes to `Config.h`
...
**Before requesting:**
- Check [existing issues](https://github.com/yourusername/cypher-chat/issues) for duplicates
...
- Updated Config.h with GPS pin definitions
...
cypher-chat uses a manager pattern for modular components:
...
- **General:** Open a [Discussion](https://github.com/yourusername/cypher-chat/discussions)
- **Bugs:** Create an [Issue](https://github.com/yourusername/cypher-chat/issues)
- **Chat:** Join our [Discord/Slack] (if available)

---

**Thank you for contributing to cypher-chat!** 🛰️
