# Starbeam Student Guide

Welcome to Starbeam, a small mesh radio like network that runs on ESP32 boards. You will build a device, send messages, and learn how multi hop networks work when the internet is not available.
