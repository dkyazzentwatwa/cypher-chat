# Starbeam - Hardware Setup Guide

A comprehensive guide to assembling and deploying your Starbeam mesh communication devices.
...
```cpp
#define DEFAULT_UNIT_NAME "STARBEAM_01"  // Change to unique name
#define DEFAULT_PASSKEY 123456            // Change for security!
```

**Device Naming Convention:**
- Use unique names for each device (STARBEAM_01, STARBEAM_02, etc.)
...
```
==========================================
STARBEAM MESH COMMUNICATION SYSTEM
==========================================
...
- ✅ Check WiFi channel (default: 1) in Config_Starbeam.h
...
- ✅ Read [STARBEAM_HANDBOOK.md](STARBEAM_HANDBOOK.md) for usage guide
