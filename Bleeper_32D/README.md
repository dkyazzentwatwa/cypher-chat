# Starbeam - ESP32 Mesh Emergency Communication System
...
**Starbeam** (formerly Bleeper_32D) is an off-grid, mesh-based emergency communication system built on ESP32. It provides multi-hop message relay, emergency broadcasts, and wireless terminal access for situations where traditional communication infrastructure is unavailable.
...
### Feature Flags (`Config_Starbeam.h`)
...
**Starbeam is designed for emergency communication and off-grid scenarios.**
...
- **Issues:** [GitHub Issues](https://github.com/yourusername/starbeam/issues)
- **Discussions:** [GitHub Discussions](https://github.com/yourusername/starbeam/discussions)
- **Documentation:** [Wiki](https://github.com/yourusername/starbeam/wiki)
