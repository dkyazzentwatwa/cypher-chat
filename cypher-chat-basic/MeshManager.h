...
private:
  ...
  void processLegacyPacket(const MeshPacket* packet, const uint8_t* senderMac, int8_t rssi);
  ...
  bool signLegacyPacket(MeshPacket* packet);
  bool verifyLegacyPacket(const MeshPacket* packet);
